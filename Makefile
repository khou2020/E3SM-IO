...
NetCDF_prefix	= ${HOME}/.local

INCLUDES	= -I$(NetCDF_prefix)/include -I. -I${HOME}/.local/include
LDFLAGS		= -L$(NetCDF_prefix)/lib -L${HOME}/.local/lib
LIBS		= -lpnetcdf $(shell $(NetCDF_prefix)/bin/nc-config --libs)
