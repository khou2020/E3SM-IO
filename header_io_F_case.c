                  ...
                  int              *varids)  /* variable IDs */
{
    ...
    /* global attributes: */
    iattr = 4;
    err = nc_put_att(ncid, NC_GLOBAL, "ne", NC_INT, 1, &iattr); ERR
    err = nc_put_att(ncid, NC_GLOBAL, "np", NC_INT, 1, &iattr); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "Conventions", 6, "CF-1.0"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "source", 3, "CAM"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "case", 20, "FC5AV1C-H01B_ne4_ne4"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "title", 5, "UNSET"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "logname", 6, "wkliao"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "host", 10, "compute001"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "Version", 6, "$Name$"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "revision_Id", 4, "$Id$"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "initial_file", 86,
    "/home/climate1/acme/inputdata/atm/cam/inic/homme/cami_mam3_Linoz_ne4np4_L72_c160909.nc"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "topography_file", 79,
    "/home/climate1/acme/inputdata/atm/cam/topo/USGS-gtopo30_ne4np4_16x.c20160612.nc"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "time_period_freq", 5, "day_5"); ERR

    /* define dimensions */
    err = nc_def_dim(ncid, "ncol", dims[1],      &dim_ncol); ERR
    err = nc_def_dim(ncid, "time", NC_UNLIMITED, &dim_time); ERR
    err = nc_def_dim(ncid, "nbnd",  2,           &dim_nbnd); ERR
    err = nc_def_dim(ncid, "chars", 8,           &dim_chars); ERR
    err = nc_def_dim(ncid, "lev",   dims[0],     &dim_lev); ERR
    err = nc_def_dim(ncid, "ilev",  dims[0]+1,   &dim_ilev); ERR
    ...
    err = nc_put_att_text(ncid, lev, "standard_name", 43, "atmosphere_hybrid_sigma_pressure_coordinate"); ERR
    err = nc_put_att_text(ncid, lev, "formula_terms", 29, "a: hyam b: hybm p0: P0 ps: PS"); ERR
    varids[i++] = lev;
    ...
    err = nc_put_att_text(ncid, ilev, "standard_name", 43, "atmosphere_hybrid_sigma_pressure_coordinate"); ERR
    err = nc_put_att_text(ncid, ilev, "formula_terms", 29, "a: hyai b: hybi p0: P0 ps: PS"); ERR
    varids[i++] = ilev;
    ...
    err = nc_put_att_text(ncid, time, "bounds", 9, "time_bnds"); ERR
    varids[i++] = time;
    ...
    err = nc_put_att_text(ncid, AEROD_v, "long_name", 43, "Total Aerosol Optical Depth in visible band"); ERR
    err = nc_put_att_text(ncid, AEROD_v, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AEROD_v;
    ...
    err = nc_put_att_text(ncid, ANRAIN, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = ANRAIN;
    ...
    err = nc_put_att_text(ncid, ANSNOW, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = ANSNOW;
    ...
    err = nc_put_att_text(ncid, AODABS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODABS;
    ...
    err = nc_put_att_text(ncid, AODABSBC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODABSBC;
    ...
    err = nc_put_att_text(ncid, AODBC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODBC;
    ...
    err = nc_put_att_text(ncid, AODDUST, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODDUST;
    ...
    err = nc_put_att_text(ncid, AODDUST1, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODDUST1;
    ...
    err = nc_put_att_text(ncid, AODDUST3, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODDUST3;
    ...
    err = nc_put_att_text(ncid, AODDUST4, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODDUST4;
    ...
    err = nc_put_att_text(ncid, AODMODE1, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODMODE1;
    ...
    err = nc_put_att_text(ncid, AODMODE2, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODMODE2;
    ...
    err = nc_put_att_text(ncid, AODMODE3, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODMODE3;
    ...
    err = nc_put_att_text(ncid, AODMODE4, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODMODE4;
    ...
    err = nc_put_att_text(ncid, AODNIR, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODNIR;
    ...
    err = nc_put_att_text(ncid, AODPOM, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODPOM;
    ...
    err = nc_put_att_text(ncid, AODSO4, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODSO4;
    ...
    err = nc_put_att_text(ncid, AODSOA, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODSOA;
    ...
    err = nc_put_att_text(ncid, AODSS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODSS;
    ...
    err = nc_put_att_text(ncid, AODUV, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODUV;
    ...
    err = nc_put_att_text(ncid, AODVIS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AODVIS;
    ...
    err = nc_put_att_text(ncid, AQRAIN, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AQRAIN;
    ...
    err = nc_put_att_text(ncid, AQSNOW, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AQSNOW;
    ...
    err = nc_put_att_text(ncid, AREI, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AREI;
    ...
    err = nc_put_att_text(ncid, AREL, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AREL;
    ...
    err = nc_put_att_text(ncid, AWNC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AWNC;
    ...
    err = nc_put_att_text(ncid, AWNI, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = AWNI;
    ...
    err = nc_put_att_text(ncid, CCN3, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = CCN3;
    ...
    err = nc_put_att_text(ncid, CLDICE, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = CLDICE;
    ...
    err = nc_put_att_text(ncid, CLDLIQ, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = CLDLIQ;
    ...
    err = nc_put_att_text(ncid, CLOUD, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = CLOUD;
    ...
    err = nc_put_att_text(ncid, CLOUDFRAC_CLUBB, "cell_methods", 10, "time: mean"); ERR
    ...
    err = nc_put_att_text(ncid, CONCLD, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = CONCLD;
    ...
    err = nc_put_att_text(ncid, DCQ, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = DCQ;
    ...
    err = nc_put_att_text(ncid, DTCOND, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = DTCOND;
    ...
    err = nc_put_att_text(ncid, EXTINCT, "units", 2, "/m"); ERR
    err = nc_put_att_text(ncid, EXTINCT, "long_name", 18, "Aerosol extinction"); ERR
    err = nc_put_att_text(ncid, EXTINCT, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = EXTINCT;
    ...
    err = nc_put_att_text(ncid, FICE, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FICE;
    ...
    err = nc_put_att_text(ncid, FLDS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FLDS;
    ...
    err = nc_put_att_text(ncid, FLNS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FLNS;
    ...
    err = nc_put_att_text(ncid, FLNSC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FLNSC;
    ...
    err = nc_put_att_text(ncid, FLNT, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FLNT;
    ...
    err = nc_put_att_text(ncid, FLNTC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FLNTC;
    ...
    err = nc_put_att_text(ncid, FLUT, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FLUT;
    ...
    err = nc_put_att_text(ncid, FLUTC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FLUTC;
    ...
    err = nc_put_att_text(ncid, FREQI, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FREQI;
    ...
    err = nc_put_att_text(ncid, FREQL, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FREQL;
    ...
    err = nc_put_att_text(ncid, FREQR, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FREQR;
    ...
    err = nc_put_att_text(ncid, FREQS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FREQS;
    ...
    err = nc_put_att_text(ncid, FSDS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSDS;
    ...
    err = nc_put_att_text(ncid, FSDSC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSDSC;
    ...
    err = nc_put_att_text(ncid, FSNS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSNS;
    ...
    err = nc_put_att_text(ncid, FSNSC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSNSC;
    ...
    err = nc_put_att_text(ncid, FSNT, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSNT;
    ...
    err = nc_put_att_text(ncid, FSNTC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSNTC;
    ...
    err = nc_put_att_text(ncid, FSNTOA, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSNTOA;
    ...
    err = nc_put_att_text(ncid, FSNTOAC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSNTOAC;
    ...
    err = nc_put_att_text(ncid, FSUTOA, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSUTOA;
    ...
    err = nc_put_att_text(ncid, FSUTOAC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = FSUTOAC;
    ...
    err = nc_put_att_text(ncid, ICIMR, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = ICIMR;
    ...
    err = nc_put_att_text(ncid, ICWMR, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = ICWMR;
    ...
    err = nc_put_att_text(ncid, IWC, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = IWC;
    ...
    err = nc_put_att_text(ncid, LINOZ_DO3, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = LINOZ_DO3;
    ...
    err = nc_put_att_text(ncid, LINOZ_DO3_PSC, "cell_methods", 10, "time: mean"); ERR
    ...
    err = nc_put_att_text(ncid, LINOZ_O3CLIM, "cell_methods", 10, "time: mean"); ERR
    ...
    err = nc_put_att_text(ncid, LINOZ_O3COL, "cell_methods", 10, "time: mean"); ERR
    ...
    err = nc_put_att_text(ncid, LINOZ_SSO3, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = LINOZ_SSO3;
    ...
    err = nc_put_att_text(ncid, LWCF, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = LWCF;
    ...
    err = nc_put_att_text(ncid, Mass_bc, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Mass_bc;
    ...
    err = nc_put_att_text(ncid, Mass_dst, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Mass_dst;
    ...
    err = nc_put_att_text(ncid, Mass_mom, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Mass_mom;
    ...
    err = nc_put_att_text(ncid, Mass_ncl, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Mass_ncl;
    ...
    err = nc_put_att_text(ncid, Mass_pom, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Mass_pom;
    ...
    err = nc_put_att_text(ncid, Mass_so4, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Mass_so4;
    ...
    err = nc_put_att_text(ncid, Mass_soa, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Mass_soa;
    ...
    err = nc_put_att_text(ncid, NUMICE, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = NUMICE;
    ...
    err = nc_put_att_text(ncid, NUMLIQ, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = NUMLIQ;
    ...
    err = nc_put_att_text(ncid, NUMRAI, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = NUMRAI;
    ...
    err = nc_put_att_text(ncid, NUMSNO, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = NUMSNO;
    ...
    err = nc_put_att_text(ncid, O3, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = O3;
    ...
    err = nc_put_att_text(ncid, OMEGA, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = OMEGA;
    ...
    err = nc_put_att_text(ncid, OMEGAT, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = OMEGAT;
    ...
    err = nc_put_att_text(ncid, Q, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Q;
    ...
    err = nc_put_att_text(ncid, QRL, "long_name", 21, "Longwave heating rate"); ERR
    err = nc_put_att_text(ncid, QRL, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = QRL;
    ...
    err = nc_put_att_text(ncid, QRS, "long_name", 18, "Solar heating rate"); ERR
    err = nc_put_att_text(ncid, QRS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = QRS;
    ...
    err = nc_put_att_text(ncid, RAINQM, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = RAINQM;
    ...
    err = nc_put_att_text(ncid, RELHUM, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = RELHUM;
    ...
    err = nc_put_att_text(ncid, SNOWQM, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = SNOWQM;
    ...
    err = nc_put_att_text(ncid, SO2, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = SO2;
    ...
    err = nc_put_att_text(ncid, SOLIN, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = SOLIN;
    ...
    err = nc_put_att_text(ncid, SSAVIS, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = SSAVIS;
    ...
    err = nc_put_att_text(ncid, SWCF, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = SWCF;
    ...
    err = nc_put_att_text(ncid, T, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = T;
    ...
    err = nc_put_att_text(ncid, TROP_P, "long_name", 19, "Tropopause Pressure"); ERR
    err = nc_put_att_text(ncid, TROP_P, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = TROP_P;
    ...
    err = nc_put_att_text(ncid, TROP_T, "long_name", 22, "Tropopause Temperature"); ERR
    err = nc_put_att_text(ncid, TROP_T, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = TROP_T;
    ...
    err = nc_put_att_text(ncid, U, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = U;
    ...
    err = nc_put_att_text(ncid, UU, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = UU;
    ...
    err = nc_put_att_text(ncid, V, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = V;
    ...
    err = nc_put_att_text(ncid, VQ, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = VQ;
    ...
    err = nc_put_att_text(ncid, VT, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = VT;
    ...
    err = nc_put_att_text(ncid, VU, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = VU;
    ...
    err = nc_put_att_text(ncid, VV, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = VV;
    ...
    err = nc_put_att_text(ncid, WSUB, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = WSUB;
    ...
    err = nc_put_att_text(ncid, Z3, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = Z3;
    ...
    err = nc_put_att_text(ncid, aero_water, "cell_methods", 10, "time: mean"); ERR
    varids[i++] = aero_water;
                  ...
                  int              *varids)  /* variable IDs */
{
    ...
    err = nc_put_att_text(ncid, NC_GLOBAL, "topography_file", 79,
    "/home/climate1/acme/inputdata/atm/cam/topo/USGS-gtopo30_ne4np4_16x.c20160612.nc"); ERR
    err = nc_put_att_text(ncid, NC_GLOBAL, "time_period_freq", 6, "hour_2"); ERR
                  ...
                  int              *varids)  /* variable IDs */
{
    ...
    /* inquery dimensions */
    err = nc_inq_dimid(ncid, "ncol", &dim_ncol); ERR
    err = nc_inq_dimid(ncid, "lev", &dim_lev); ERR

    err = nc_inq_dimlen(ncid, dim_ncol, ((MPI_Offset*)dims) + 1); ERR
    err = nc_inq_dimlen(ncid, dim_lev, (MPI_Offset*)dims); ERR
