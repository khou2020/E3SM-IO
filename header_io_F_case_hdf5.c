                  ...
                  int              *varids)  /* variable IDs */
{
    ...
    dimids[0] = dim_time;
    dimids[1] = dim_ncol;
    err       = hdf5_def_var (ncid, "AODALL", NC_FLOAT, 2, dimids, &AODALL);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, AODALL, _FillValue, NC_FLOAT, 1, &fillv);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, AODALL, "missing_value", NC_FLOAT, 1, &missv);
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, AODALL, "long_name", 35, "AOD 550 nm for all time and species");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, AODALL, "cell_methods", 10, "time: mean");
    ERR
    varids[i++] = AODALL;
    ...
    dimids[0] = dim_time;
    dimids[1] = dim_ncol;
    err       = hdf5_def_var (ncid, "BURDEN1", NC_FLOAT, 2, dimids, &BURDEN1);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN1, _FillValue, NC_FLOAT, 1, &fillv);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN1, "missing_value", NC_FLOAT, 1, &missv);
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN1, "units", 5, "kg/m2");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN1, "long_name", 21, "Aerosol burden mode 1");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN1, "cell_methods", 10, "time: mean");
    ERR
    varids[i++] = BURDEN1;

    dimids[0] = dim_time;
    dimids[1] = dim_ncol;
    err       = hdf5_def_var (ncid, "BURDEN2", NC_FLOAT, 2, dimids, &BURDEN2);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN2, _FillValue, NC_FLOAT, 1, &fillv);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN2, "missing_value", NC_FLOAT, 1, &missv);
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN2, "units", 5, "kg/m2");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN2, "long_name", 21, "Aerosol burden mode 2");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN2, "cell_methods", 10, "time: mean");
    ERR
    varids[i++] = BURDEN2;

    dimids[0] = dim_time;
    dimids[1] = dim_ncol;
    err       = hdf5_def_var (ncid, "BURDEN3", NC_FLOAT, 2, dimids, &BURDEN3);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN3, _FillValue, NC_FLOAT, 1, &fillv);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN3, "missing_value", NC_FLOAT, 1, &missv);
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN3, "units", 5, "kg/m2");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN3, "long_name", 21, "Aerosol burden mode 3");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN3, "cell_methods", 10, "time: mean");
    ERR
    varids[i++] = BURDEN3;

    dimids[0] = dim_time;
    dimids[1] = dim_ncol;
    err       = hdf5_def_var (ncid, "BURDEN4", NC_FLOAT, 2, dimids, &BURDEN4);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN4, _FillValue, NC_FLOAT, 1, &fillv);
    ERR
    err = HDF5_PUT_ATT_FLOAT (ncid, BURDEN4, "missing_value", NC_FLOAT, 1, &missv);
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN4, "units", 5, "kg/m2");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN4, "long_name", 21, "Aerosol burden mode 4");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, BURDEN4, "cell_methods", 10, "time: mean");
    ERR
    varids[i++] = BURDEN4;
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, CLDICE, "mixing_ratio", 3, "wet");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, CLDLIQ, "mixing_ratio", 3, "wet");
    ERR
    err =
    ...
    dimids[0] = dim_time;
    dimids[1] = dim_ncol;
    err       = hdf5_def_var (ncid, "LINOZ_SFCSINK", NC_FLOAT, 2, dimids, &LINOZ_SFCSINK);
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, LINOZ_SFCSINK, "units", 8, "Tg/yr/m2");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, LINOZ_SFCSINK, "long_name", 64,
                             "surface o3 sink in LINOZ with an e-fold to a fixed concentration");
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, LINOZ_SFCSINK, "cell_methods", 10, "time: mean");
    ERR
    varids[i++] = LINOZ_SFCSINK;
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, NUMICE, "mixing_ratio", 3, "wet");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, NUMLIQ, "mixing_ratio", 3, "wet");
    ERR
    err =
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, NUMRAI, "mixing_ratio", 3, "wet");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, NUMSNO, "mixing_ratio", 3, "wet");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, O3, "mixing_ratio", 3, "dry");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, Q, "mixing_ratio", 3, "wet");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, RAINQM, "mixing_ratio", 3, "wet");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, SNOWQM, "mixing_ratio", 3, "wet");
    ERR
    ...
    ERR
    err = HDF5_PUT_ATT_TEXT (ncid, SO2, "mixing_ratio", 3, "dry");
    ERR
